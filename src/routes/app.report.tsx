    ...
    <div className="min-h-screen">
      ...
      <div className="space-y-6 p-8">
        {done.length === 0 ? (
          ...
          <>
            <div className="rounded-3xl border-2 border-brand/30 bg-brand/5 p-8">
              <div className="flex items-center gap-2 text-brand">
                <Check className="size-5" />
                <h2 className="text-2xl font-bold">{data.project.name} v1 is ready.</h2>
              </div>
            ...
            <div className="rounded-3xl border border-border bg-card p-6">
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                <Link to="/app/deployments" className="inline-flex items-center gap-1.5 rounded-full bg-foreground px-4 py-2 text-sm text-background hover:opacity-90">
                  <Rocket className="size-3.5" /> View deployments
                </Link>
                <Link to="/app/failures" className="inline-flex items-center gap-1.5 rounded-full border border-border bg-background px-4 py-2 text-sm hover:bg-muted">
                  See all recoveries
                </Link>
                <Link to="/app/chat" className="inline-flex items-center gap-1.5 rounded-full border border-border bg-background px-4 py-2 text-sm hover:bg-muted">
                  Add another feature
                </Link>
              </div>
            </div>
